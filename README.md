...
# Домашнее задание к занятию 4 «Оркестрация группой Docker контейнеров на примере Docker Compose» - Блинов А.С.
...
![scrin3](https://github.com/AleksanderB5/devops-netology/blob/OrkDoc/foto/1-3%20док.png)
![scrin4](https://github.com/AleksanderB5/devops-netology/blob/OrkDoc/foto/1-4%20док.png)
![scrin5](https://github.com/AleksanderB5/devops-netology/blob/OrkDoc/foto/1-5%20док.png)
![scrin6](https://github.com/AleksanderB5/devops-netology/blob/OrkDoc/foto/1-6%20док.png)
![scrin7](https://github.com/AleksanderB5/devops-netology/blob/OrkDoc/foto/1-7%20док.png)
...
![scrin1](https://github.com/AleksanderB5/devops-netology/blob/OrkDoc/foto/2-1%20док.png)
![scrin2](https://github.com/AleksanderB5/devops-netology/blob/OrkDoc/foto/2-2%20док.png)
...
3. Выполните ```docker ps -a```
и объясните своими словами почему контейнер остановился.
4. Перезапустите контейнер
5. Зайдите в интерактивный терминал контейнера "custom-nginx-t2" с оболочкой bash.
6. Установите любимый текстовый редактор(vim, nano итд) с помощью apt-get.
7. Отредактируйте файл "/etc/nginx/conf.d/default.conf", заменив порт "listen 80" на "listen 81".
8. Запомните(!) и выполните команду ```nginx -s reload```
, а затем внутри контейнера ```curl http://127.0.0.1:80 ; curl http://127.0.0.1:81```
.
9. Выйдите из контейнера, набрав в консоли  ```exit```
или Ctrl-D.
...
----
```Нажимаем ctrl+c и у нас завершается работа контейнера. Ctrl+c это стандарный сигнал заврешения процесса, чтобы контейнер работал в фоне, нужно установить ключи (-d, -it) и тогда мы просто отключимся от него, а не завершим работу контейнера.```
----
